      ...
      <div className="grid grid-cols-1 gap-x-4 gap-y-2 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2">
          <div className=" bg-white shadow-lg">
            <h1 className="text-2xl font-medium px-8 py-4 tracking-wide">
              Order Summary
            </h1>
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <div className="text-gray-500 flex items-center">
                            ...
                            <select className="bg-white-50 w-[50px] ml-5 border border-gray-300 text-gray-900 text-sm rounded-md block p-1">
